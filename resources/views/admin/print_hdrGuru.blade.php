...
<head>
	<meta charset="UTF-8">
	<title>Laporan Absensi Hadir Guru</title>
...
<body onload="window.print();">
	<div class="container">
		...
		<div class="nama-perusahaan">Laporan Absensi Kehadiran Guru</div>
                ...
                <table id="print-document" class="table table-bordered data-table">
                    ...
                    <tbody>
                        ...
                        @foreach($hadirs as $hadir)
                            ...
                            <tr>
                                <td>{{ $no }}</td>
                                <td>{{ $hadir->guru->kd_guru }}</td>
                                <td>{{ $hadir->guru->name }}</td>
                                <td>{{ $hadir->jam_masuk}}</td>
                                <td>{{ $hadir->jam_pulang}}</td>
                                <td>{{ $hadir->koordinate_gps_masuk}}</td>
                                <td>{{ $hadir->koordinate_gps_pulang}}</td> 
